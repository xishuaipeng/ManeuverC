...
for i =1:length(videoName)
    ...
    out_path = 'D:\xishuaip\TRI\Project\oldprocess';
    checkFile = sprintf('%s/%s/%s.list',input_path,videoName{i}, videoName{i});
    
    remove_mat(out_path,{'seqX_5.000000_1.000000_10.000000_5.000000.mat';'seqY_5.000000_1.000000_10.000000_5.000000.mat'} );
