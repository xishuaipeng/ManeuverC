...
class Inception_v3(Encoder):
    ...
    def build(self, input_shape = [None, 299, 299, 3],n_class=1 ):
        inputs = tf.placeholder(tf.float32,shape = input_shape, name='Inputs')
        arg_scope = slimNet.inception.inception_v3_arg_scope(batch_norm_decay=0.9997, batch_norm_epsilon=0.001,use_fused_batchnorm=True)
        with slim.arg_scope(arg_scope):
    ...
    def back_bone(self,input_shape ):
        ...
        return self.end_points['Inputs'], self.end_points['Mixed_7c']